...
public class AutoRoute5 extends SequentialCommandGroup {
  ...
  public AutoRoute5(Drivetrain drivetrain, Shooter shooter, Intake intake, Indexer indexer, Lights lights, double rpm) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new ShootingRoutine(indexer, shooter, lights, rpm));
  }
}
