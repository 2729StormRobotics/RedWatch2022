...
public class ShootingRoutineDouble extends SequentialCommandGroup {
  ...
  // }
     ...
     */
  public ShootingRoutineDouble(Indexer indexer, Shooter shooter, Lights lights, double rpm)  {
    addCommands(
